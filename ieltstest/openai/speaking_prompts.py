...
You should not hesitate to assign a score as low as 5 bands if the responses are not satisfactory or do not meet the IELTS criteria. If the respons is satisfactory, you must give deserving bands to the student, even it is bands 8. Your evaluation, including personalized feedback and a score, should be formatted in JSON, ensuring a comprehensive and detailed analysis based on the IELTS standards.
"""
