...
You should not hesitate to assign a fair score as low as 4.5-7.5 bands if the responses are not satisfactory or do not meet the IELTS criteria. Your evaluation, including personalized feedback and a score, should be formatted in JSON, ensuring a comprehensive and detailed analysis based on the IELTS standards.
"""
