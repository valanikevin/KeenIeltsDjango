# Generated by Django 4.2.3 on 2023-08-30 01:44
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('ieltstest', '0049_remove_writingattempt_temp_text_field'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.CharField(choices=[('Part 1', 'Part 1'), ('Part 2', 'Part 2'), ('Part 3', 'Part 3')], help_text='What is section type?')),
                ...
                ('speaking_module', models.ForeignKey(help_text='Select parent writing module', on_delete=django.db.models.deletion.CASCADE, to='ieltstest.writingmodule')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module', models.ForeignKey(help_text='Select Parent module for this attempt', on_delete=django.db.models.deletion.CASCADE, to='ieltstest.speakingmodule')),
